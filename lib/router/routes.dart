...
class MyAppRouter {
  static final router = GoRouter(
    initialLocation: '/${AppRoute.successfullyAccounttCreate}',
    routes: [
      ///Auth Section
      // GoRoute(
      //   name: AppRoute.sendOtp,
      //   path: '/${AppRoute.sendOtp}',
      //   pageBuilder: (context, state) {
      //     log('going to sendotp');
...
////AuthSection
  ...
  static const String otpVerifyScreen = 'otpVerify-page';
